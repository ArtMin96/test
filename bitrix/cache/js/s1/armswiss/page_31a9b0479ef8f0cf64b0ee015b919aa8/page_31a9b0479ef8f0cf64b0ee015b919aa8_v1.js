...
/* End */
;
; /* Start:"a:4:{s:4:"full";s:86:"/local/templates/armswiss/components/bitrix/news.list/projects/script.js?1575989499187";s:6:"source";s:72:"/local/templates/armswiss/components/bitrix/news.list/projects/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
$(document).ready(function () {

    var filterBtn = $('.filters button');

    $(document).on('click', filterBtn, function () {
        console.log(filterBtn.data('filter'));
    });
});
/* End */
;; /* /local/templates/armswiss/components/bitrix/system.pagenavigation/show_more/script.js?15759690461177*/
; /* /local/templates/armswiss/components/bitrix/news.list/projects/script.js?1575989499187*/
